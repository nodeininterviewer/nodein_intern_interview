...
For this problem you are only required to find the best model of a line defined by the equation y=mx+c. So your ransac algorithm should spit out the the m and c parts of your line equation. The last step improvement via least squares is not needed.
